...
const hiddenelements2 = document.querySelectorAll(".trading-content");
...
const hiddenelements4 = document.querySelectorAll(".how-ib");
...
const observer5 = new IntersectionObserver((entries5) => {
    entries5.forEach((entry5)=>{
        ...
        if (entry5.isIntersecting){
            entry5.target.classList.add('animate__animated', 'animate__flash','animate__delay-1s');
        }
    });
});

const hiddenelements5 = document.querySelectorAll(".become-btn");
...
const observer7 = new IntersectionObserver((entries7) => {
    entries7.forEach((entry7)=>{
        ...
        if (entry7.isIntersecting){
            entry7.target.classList.add('animate__animated', 'animate__bounceIn');
        }
    });
});

const hiddenelements7 = document.querySelectorAll(".stats");
